...
export const SHELL_ICONS = {
  ...
  mark: '<svg viewBox="0 0 52 52" fill="none" width="100%" height="100%"><path d="M12.5,15.5 V14 A6,6 0 0 1 18.5,8 H39.5" stroke="var(--k-ext-mark-logo)" stroke-width="2.85" stroke-linecap="round"/><polyline points="33.5,2 39.5,8 33.5,14" stroke="var(--k-ext-mark-logo)" stroke-width="2.85" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M39.5,18.5 V20 A6,6 0 0 1 33.5,26 H12.5" stroke="var(--k-ext-mark-logo)" stroke-width="2.85" stroke-linecap="round"/><polyline points="18.5,32 12.5,26 18.5,20" stroke="var(--k-ext-mark-logo)" stroke-width="2.85" stroke-linecap="round" stroke-linejoin="round" fill="none"/><rect x="8" y="34" width="36" height="4" rx="2" fill="var(--k-ext-mark-logo)" opacity="0.9"/><rect x="8" y="40" width="36" height="4" rx="2" fill="var(--k-ext-mark-logo)" opacity="0.65"/><rect x="8" y="46" width="36" height="4" rx="2" fill="var(--k-ext-mark-logo)" opacity="0.4"/></svg>',
  wrench:
